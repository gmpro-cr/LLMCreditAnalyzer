...
def test_apply_caps_confidence_and_appends_limitations():
    memo = ("*Generated by CreditGuard AI | Confidence: HIGH*\n\n"
    ...
    assert "**HIGH**" not in out             # bold confidence capped
    assert "Confidence: HIGH" not in out     # plaintext header capped too
